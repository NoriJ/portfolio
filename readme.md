...
[!button size="m" icon="link" variant="light" text="Root-me Profile"](https://www.root-me.org/Nori-485633?inc=info&lang=fr) [!button size="m" icon="mark-github" variant="light" text="GitHub"](https://github.com/NoriJ) [!button size="m" icon="person" variant="light" text="LinkedIn"](https://linkedin.com/in/rayan-lejrhoul)
